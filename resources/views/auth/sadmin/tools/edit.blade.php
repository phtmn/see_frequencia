                                ...
                                <div class="row col-sm-12">
                                    <div class="col-sm-6">
                                        ...
                                        <input class="form-control" type="text" name="tiktok" id="tiktok" 
                                            placeholder="Link do Tik Tok" value="{{ $tool->tiktok }}">
                                    </div>
                                    <div class="col-sm-6">
                                        <label class="form-label" for="youtube">Youtube</label>
                                        <input class="form-control" type="text" name="youtube" id="youtube" 
                                            placeholder="Link do Youtube" value="{{ $tool->youtube }}">
                                    </div>
                                </div>
                                <div class="row col-sm-12">
                                    <div class="col-sm-6">
                                        ...
                                        <input class="form-control" type="text" name="facebook" id="facebook" 
                                            placeholder="Link do Facebook" value="{{ $tool->facebook }}">
                                    </div>
                                    <div class="col-sm-6">
                                        <label class="form-label" for="instagram">Instagram</label>
                                        <input class="form-control" type="text" name="instagram" id="instagram" 
                                            placeholder="Link do Instagram" value="{{ $tool->instagram }}">
                                    </div>
                                </div>
                                <div class="row col-sm-12">
                                    <div class="col-sm-6">
                                        ...
                                        <input class="form-control" type="text" name="twitter" id="twitter" 
                                            placeholder="Link do Twitter" value="{{ $tool->twitter }}">
                                    </div>
                                    <div class="col-sm-6">
                                        <label class="form-label" for="linkedin">LinkedIn</label>
                                        <input class="form-control" type="text" name="linkedin" id="linkedin" 
                                            placeholder="Link do LinkedIn" value="{{ $tool->linkedin }}">
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <label class="form-label" for="fn">Descrição</label>
                                    <textarea class="form-control" name="description" id="description" cols="30" rows="10">{{ $tool->description}}</textarea>
                                </div>
