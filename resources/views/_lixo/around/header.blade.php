<header class="navbar navbar-expand-lg fixed-top">
    <div class="container"><a class="navbar-brand pe-sm-3" href="{{ route('home.index')}}"><span class="text-primary flex-shrink-0 me-1">
                <img class="d-block  mb-2 rounded-circle" src="{{ asset('assets/img/roree-removebg-preview.png') }}" width="75"></span>ROREE</a>

        <div class="  order-lg-2  me-lg-4 ms-auto">

        </div>
        <div class="  order-lg-2  me-lg-4 ms-auto">
            <a href="{{ route('favorites.index')}}" class="{{ (\Request::route()->getName() == 'favorites.index') ? 'nav-link active text-warning' : 'nav-link' }} "><i class="ai-star-filled fs-4 opacity-70 me-1"></i></a>
